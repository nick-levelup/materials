...
/* --------------------- */
// Функции, объявленные как Function Declaration, создаются интерпретатором
// до выполнения кода.
var age = 20;
...
// Function Expression. Функцию можно создать и присвоить переменной как самое
// обычное значение.
/* --------------------- */
...
// Если браузер видит function в основном потоке кода - он считает,
// что это Function Declaration.
//Если же function идёт в составе более сложного выражения,
// то он считает, что это Function Expression.
/* --------------------- */
+function() {
